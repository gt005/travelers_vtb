...
class DataUnit(models.Model):
    ...
    document1 = models.FileField(verbose_name='Файл', upload_to='addition_files', blank=True)
    document2 = models.FileField(verbose_name='Файл', upload_to='addition_files', blank=True)
    document3 = models.FileField(verbose_name='Файл', upload_to='addition_files', blank=True)
